---
title: tornadosql源码解读
date: 2019-05-03T19:28:03+08:00
tags: ['tornadosql', 'tornado', 'Python', '源码解读']
categories: ['源码解读']
---

### tornadosql源码解读

因为MySQLdb不支持Python3，并且Python2将于2020.1.1停止维护，所以将MySQLdb替换为pymysql以兼容Python3。代码改编自[torndb](https://github.com/bdarnell/torndb),已开源安装`pip install tornadosql`
